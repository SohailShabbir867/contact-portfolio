...
const projects = [
  {
    ...
    description: (
      <ul>
        <li>Built with React.js and Tailwind CSS</li>
        <li>Showcases the Fast food menu and ordering system</li>
        <li>Fully responsive and mobile-friendly animation and Hower effects</li>
        <li>Provides smooth user experience across all devices</li>
      </ul>
    ),
    image: require("../assests/Foodgarden.png"),
    button:( <a href="https://sohailshabbir867.github.io/Food-Garden/"><button className="about-button">View Project</button></a>)
  },
  {
    title: "E-commerce UI",
    description: (
      <ul>
        <li>Designed with React js ,Vite and Tailwind CSS</li>
  ...
  },
  {
    ...
    description: (
      <ul>
        ...
        <li>Simple and user-friendly interface with Fast response</li>
      </ul>
    ),
